...
public class DateMessageBodyWriter implements MessageBodyWriter<Date>{
	...
	public long getSize(Date t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
		...
		//return MessageBodyWriter.super.getSize(t, type, genericType, annotations, mediaType);
		return -1;
	}
	...
	@Override
	public void writeTo(Date date, Class<?> type, Type genericType, Annotation[] annotations, 
